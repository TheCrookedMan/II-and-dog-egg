...
let url = "http://localhost:" + config.post,
    dist_dir = "./dist/",
...
const plugins_src = {
    inputfile_js: [src_plugins_dir + "/jquery.min.js", src_plugins_dir + "/common.js", src_plugins_dir + "/upload.js", src_plugins_dir+'/echo.js'],
